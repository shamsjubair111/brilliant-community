...
const NavBar = ({isDrawerOpen,setIsDrawerOppen,toggleDrawer}) => {
    ...
    return (
        ...
        <div className="flex justify-between items-center pr-16 pl-8 py-9" style={{height:"60px", boxShadow: "0px 4px 8px rgba(0, 0, 0, 0.2)"}} >
          ...
          <div className="mr-8 flex align-center">
            ...
            <FontAwesomeIcon icon={faBars} className="ml-40 mt-1.5"  style={{color: "#17177b" , cursor: "pointer"}} onClick={toggleDrawer}/>
          </div>
